...
//  Date
//
//  Created by Mike Smith on 2/18/13.
...
int main(int argc, char *argv[])
{
    @autoreleasepool {
		...
		NSLog(@"A year has %d months.", [today yearLength]);
        ...
        [[Date alloc] initWithMonth: 7 day: 4 year: 1776 //2147483647
         ];
		...
		NSLog(@"Independence Day was actually on %@.", independenceDay);
